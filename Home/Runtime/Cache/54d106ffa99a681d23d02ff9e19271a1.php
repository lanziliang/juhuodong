...
.userup-icon {
    ...
    height: 16px;
    vertical-align: -2px;
	background: url("__PUBLIC__/Images/userup_icon.png") no-repeat;
}
.uploadify-button {
...
<div style="margin: 20px 0 10px;">
	...
	<div style="margin-bottom: 10px;">
		...
		<img style="max-width: 750px;" src="__ROOT__/Public/avatar/temp.jpg" title="临时图片"/>
	</div>
	<div>
		<span style="vertical-align: top">裁切图片：</span>
		<img src="__ROOT__/Public/avatar/avatar_100.jpg" title="100*100"/>
		<img src="__ROOT__/Public/avatar/avatar_60.jpg" title="60*60"/>
		<img src="__ROOT__/Public/avatar/avatar_30.jpg" title="30*30"/>
	</div>
</div>
<!-- /展示头像 -->
</div>
