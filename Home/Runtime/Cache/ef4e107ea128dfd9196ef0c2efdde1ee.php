...
<div id="db-usr-profile">
  ...
  <div class="info">
    ...
    <div class="grid-free clearfix">
		     ...
		     <div class="article" id="xq2" style="display:block;">
               
  
  
  <div class="tabs norm-tabs" >
         <a href="__URL__/faqi/people/<?php echo ($id); ?>"   >可参加 <em>(<?php echo ($xqok); ?>)</em></a>
        <a href="__URL__/faqiover/people/<?php echo ($id); ?>"   class="on">已过期 <em>(<?php echo ($xqover); ?>)</em></a>
  </div>

    
  <ul class="events-list events-list-pic100 events-list-psmall">
  <?php if(is_array($guoqi)): foreach($guoqi as $key=>$vo): ?><li class="list-entry" itemscope="" itemtype="http://data-vocabulary.org/Event">
      <div class="pic">
        <a href="__URL__/detail/event/<?php echo ($vo["id"]); ?>">
          <img  src="__PUBLIC__/Uploads/<?php echo ($vo["image"]); ?>" itemprop="photo" width="110" height="200">
        </a>
      </div>
      <div class="info">
        <div class="title">
